...
Tsc_h = 324;    % T high internal spacecraft [K]
Tsc_c = 225;    % T cold internal spacecraft [K]
...
Wir_e = 228;            % Heat flux radiation from Earth [W/m^2]
...
b=bar(Y,'stacked','BaseValue',275);bl = b.BaseLine;c1 = bl.Color;
bl.Color = 'blue';
